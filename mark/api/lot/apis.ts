export const assignDisplayIdToLot = async (lotId:string ,displayId:string , token:string) => {
  try {
...
export const assignToShipping = async (shippingId: string, lotId: string, token: string) : Promise<void> => {
 try {
